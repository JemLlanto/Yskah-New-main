...
<body>
    ...
    <div id="container" class="container-fluid-sm container-md rounded mb-3 mt-3 p-3">
        ...
        <?php if ($result->num_rows > 0) : ?>
                    ...
                    <a href="admin_order_status.php?order_id=<?php echo $order['order_id']; ?>&status=<?php echo $order['status']; ?>&user_id=<?php echo $order['user_id']; ?>">
                        ...
                        <div id="order_item" class="rounded mt-3 p-2">
                            <div id="order_head" class="container w-100 mb-2 p-2 me-0">
                                ...
                                <p id="shipping_information_text" class="m-0 text-end">Item/s Delivered.</p>
                            </div>
            ...
            <?php endwhile; ?>
        <?php else : ?>
            <div id="" class="container rounded p-2 bg-light mt-1 text-center d-flex align-items-center justify-content-center" style="height: 150px" s>
                <h5>Empty Order.</h5>
            </div>
        <?php endif; ?>
    </div>
