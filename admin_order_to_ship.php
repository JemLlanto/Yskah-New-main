...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['confirm_order'])) {
    ...
    $sql_update = "UPDATE order_items SET status = 'Shipped' WHERE order_number = ?";
...
// ";
    ...
    LEFT JOIN variant_content vc ON FIND_IN_SET(vc.variant_content_id, o.variant_content_ids)
    WHERE o.status = 'Shipping'
    GROUP BY o.order_id, o.user_id, o.order_number, o.product_name, o.variant_content_ids, o.quantity, o.price, o.order_date, o.status
                    ...
                    <a
                        ...
                        <div id="order_item" class="rounded mt-3 p-2">
                            <div id="order_head" class="container w-100 mb-2 p-2 me-0">
                                ...
                                <input type="hidden" name="title" value="Order Shipped">
                                <input type="hidden" name="description"
                                    value="Your Order has been Shipped by the Seller. Click for more details">
