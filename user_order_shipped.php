...
<body>
    ...
    $sql = "SELECT * FROM order_items WHERE status = 'Shipped' AND user_id = ?";
    ...
    <div id="container" class="container-fluid-sm container-md rounded mb-3 mt-3 p-3">
        ...
        <a
            href="user_order_status.php?order_id=<?php echo $order['order_id']; ?>&status=<?php echo $order['status']; ?>&user_id=<?php echo $order['user_id']; ?>">
