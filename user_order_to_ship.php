...
<body>
    ...
    $sql = "SELECT * FROM order_items WHERE status = 'Shipping' AND user_id = ? GROUP BY order_number";
                ...
                <a
                    ...
                    <div id="order_item" class="rounded mt-3 p-2">
                        <div id="order_head" class="container w-100 mb-2 p-2 me-0">
                            ...
                            <p id="shipping_information_text" class="m-0 text-end">The seller is preparing the order/s.</p>
                        </div>
