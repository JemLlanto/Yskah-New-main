...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['confirm_order'])) {
    ...
    $sql_update = "UPDATE order_items SET status = 'Shipping' WHERE order_number = ?";
    ...
    header("Location: admin_order_to_ship.php");
    exit();
}
?>
<!DOCTYPE html>
...
<body>
    ...
    $sql = "SELECT * FROM order_items WHERE status = 'pending' GROUP BY order_number";
